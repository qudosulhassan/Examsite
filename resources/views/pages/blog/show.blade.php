...
<style>
    ...
    .blog-content-body h2 { font-size: 1.6rem; border-bottom: 2px solid #F1F5F9; padding-bottom: 0.5rem; }
    .blog-content-body h3 { font-size: 1.3rem; }
    .blog-content-body h4 { font-size: 1.1rem; }
    .blog-content-body p { margin-bottom: 1.25rem; }
    .blog-content-body ul { list-style-type: disc; padding-left: 1.5rem; margin-bottom: 1.25rem; }
    .blog-content-body ol { list-style-type: decimal; padding-left: 1.5rem; margin-bottom: 1.25rem; }
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-8">
        ...
        <article class="lg:w-2/3 bg-white rounded-xl shadow border border-gray-100 overflow-hidden">
            ...
            <div class="p-8 md:p-12">
                <div class="blog-content-body prose prose-lg prose-cyan max-w-none text-gray-700">
                    {!! $post->content !!}
                </div>
