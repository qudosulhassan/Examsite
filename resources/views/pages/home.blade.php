...
<section class="py-24 bg-navy border-t border-gray-900 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-20">
            <h2 class="text-3xl font-black text-white sm:text-4xl mb-4 tracking-tight">How ExamsNinja Works</h2>
...
<!-- Why Choose ExamsNinja? (Features) -->
<section class="py-24 bg-gray-50 border-t border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-black text-navy sm:text-4xl mb-4 tracking-tight">Why Choose ExamsNinja?</h2>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white/5 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-white/10 relative group hover:-translate-y-2 transition-transform duration-300">
                ...
                <p class="text-base text-gray-300 mb-8 italic leading-relaxed font-light">"I was skeptical about dumps, but ExamsNinja's AZ-104 study guide was 100% accurate. 42 out of 45 questions on my exam were identical to the guide. Highly recommended!"</p>
            ...
            <div class="bg-white/5 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-white/10 relative group hover:-translate-y-2 transition-transform duration-300">
                ...
                <p class="text-base text-gray-300 mb-8 italic leading-relaxed font-light">"CompTIA Security+ was a beast, but the explanations inside the ExamsNinja package helped me understand why an option was correct, rather than just memorizing answers."</p>
                <div class="flex items-center space-x-4 pt-4 border-t border-white/10">
        ...
        <div class="space-y-4" x-data="{ active: null }">
            ...
            <div class="bg-white border border-gray-100 rounded-xl overflow-hidden hover:border-cyan/30 transition-colors">
                ...
                <div x-show="active === 3" x-collapse x-cloak>
                    <div class="px-6 pb-5 text-gray-500 font-medium leading-relaxed">
                        No. When you purchase an ExamsNinja study pack, you receive 90 days of free updates automatically. If the vendor changes the exam during that time, you'll instantly get the new questions in your account.
                    </div>
                </div>
            </div>
...
<section class="relative py-20 overflow-hidden bg-navy">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <p class="text-xl text-white/90 mb-10 max-w-2xl mx-auto font-medium">Join 250,000+ professionals who passed their certification exams on the first attempt with ExamsNinja.</p>
