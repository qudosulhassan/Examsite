            ...
            <div class="flex flex-col flex-grow bg-navy pt-5 overflow-y-auto">
                ...
                <div class="flex-grow flex flex-col">
                    <nav class="flex-1 px-2 space-y-1 pb-4">
                        ...
                        <a href="{{ route('admin.sites.index') }}" class="group flex items-center justify-between px-4 py-2.5 text-sm font-medium rounded-md transition {{ request()->routeIs('admin.sites.*') ? 'bg-gray-800 text-cyan border-l-4 border-cyan' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                            <span class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-cyan" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/></svg>
                                <span>Websites Platform</span>
                            </span>
