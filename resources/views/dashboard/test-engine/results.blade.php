...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <nav class="flex text-xs text-gray-400 space-x-2">
        ...
        <span>/</span>
        <span class="text-gray-500 font-semibold">Results #{{ $attempt->id }}</span>
    </nav>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 shadow-sm text-center space-y-6">
        ...
        <div class="pt-6 border-t border-gray-150 dark:border-gray-700 flex flex-wrap justify-center gap-4">
            <a href="{{ route('dashboard.test-engine.lobby', $exam->slug) }}" class="bg-orange hover-bg-orange text-white text-sm font-bold py-2.5 px-6 rounded shadow transition">
                Retake Exam Simulator
            </a>
            <a href="{{ route('dashboard.test-engine') }}" class="border border-gray-300 text-navy hover:bg-gray-50 text-sm font-bold py-2.5 px-6 rounded transition">
                Choose Another Exam
            </a>
        </div>
    </div>
