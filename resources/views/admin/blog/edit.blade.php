                            ...
                            <div class="bg-white rounded-xl shadow-2xl max-w-md w-full p-5 space-y-4">
                                ...
                                <div class="space-y-3 text-xs">
                                    ...
                                    <div class="flex items-center gap-2 pt-1">
                                        <input type="checkbox" id="link_target_blank_edit" class="link-modal-target rounded border-gray-300 text-cyan focus:ring-cyan" checked>
                                        <label for="link_target_blank_edit" class="text-xs text-gray-700 font-medium cursor-pointer">Open link in new browser tab (<code>target="_blank"</code>)</label>
                                    </div>
                                </div>
