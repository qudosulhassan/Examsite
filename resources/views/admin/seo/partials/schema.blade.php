    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-150 bg-gray-50/70 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div class="flex items-center space-x-2">
                ...
                <a href="https://search.google.com/test/rich-results?url={{ urlencode(url('/exams/microsoft/az-900')) }}" target="_blank" class="inline-flex items-center px-2.5 py-1.5 text-xs font-bold text-navy hover:text-cyan bg-white border border-gray-300 rounded-lg shadow-sm transition gap-1">
