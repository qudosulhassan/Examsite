        ...
        <form action="{{ route('admin.exams.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="exam_code" id="exam_code" required value="{{ old('exam_code') }}" placeholder="e.g. AZ-900"
                           class="w-full border-gray-300 rounded text-sm px-3 py-2 focus:border-cyan focus:ring-cyan">
                    @error('exam_code')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
            ...
            <div x-data="certDropdown({{ $certData }}, [])" class="relative">
            ...
            <div>
                ...
                <input type="text" name="exam_name" id="exam_name" required value="{{ old('exam_name') }}" placeholder="e.g. AWS Certified Solutions Architect - Associate"
                       class="w-full border-gray-300 rounded text-sm px-3 py-2 focus:border-cyan focus:ring-cyan">
                @error('exam_name')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="price_pdf" id="price_pdf" required value="{{ old('price_pdf', '29.00') }}"
                           class="w-full border-gray-300 rounded text-sm px-3 py-2 focus:border-cyan focus:ring-cyan">
                    @error('price_pdf')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="price_engine" id="price_engine" required value="{{ old('price_engine', '39.00') }}"
                           class="w-full border-gray-300 rounded text-sm px-3 py-2 focus:border-cyan focus:ring-cyan">
                    @error('price_engine')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="passing_score" id="passing_score" required value="{{ old('passing_score', '70') }}" min="50" max="100"
                           class="w-full border-gray-300 rounded text-sm px-3 py-2 focus:border-cyan focus:ring-cyan">
                    @error('passing_score')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="question_count" id="question_count" value="{{ old('question_count', '0') }}" min="0"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="update_price_3_months" id="update_price_3_months" value="{{ old('update_price_3_months', '0.00') }}"
                           class="w-full border-gray-300 rounded text-sm px-3 py-2 focus:border-cyan focus:ring-cyan">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="update_price_6_months" id="update_price_6_months" value="{{ old('update_price_6_months', '10.00') }}"
                           class="w-full border-gray-300 rounded text-sm px-3 py-2 focus:border-cyan focus:ring-cyan">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="update_price_12_months" id="update_price_12_months" value="{{ old('update_price_12_months', '20.00') }}"
                           class="w-full border-gray-300 rounded text-sm px-3 py-2 focus:border-cyan focus:ring-cyan">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="exam_type" id="exam_type" required
                        ...
                        <option value="LabBased">Lab-Based Case Studies</option>
                    </select>
                    @error('exam_type')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
            ...
            <div>
                ...
                <input type="text" name="topics" id="topics" value="{{ old('topics') }}" placeholder="e.g. Cloud Concepts, Security, Billing"
                       class="w-full border-gray-300 rounded text-sm px-3 py-2 focus:border-cyan focus:ring-cyan">
            ...
            <!-- Description -->
            <div class="mb-6 tiptap-container" data-content="{{ base64_encode(old('description')) }}">
            ...
            <div class="bg-gray-50 -mx-8 px-8 py-6 border-t border-b border-gray-150 mb-8">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title') }}" placeholder="e.g., Best AWS Certified Cloud Practitioner Practice Exams"
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="2" placeholder="Write a compelling description for Google search results..."
                                  class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-sm text-gray-700 focus:outline-none focus:border-cyan focus:ring-1 focus:ring-cyan">{{ old('meta_description') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="e.g., aws exam dumps, clf-c02 practice test, cloud practitioner"
                               class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-sm text-gray-700 focus:outline-none focus:border-cyan focus:ring-1 focus:ring-cyan">
