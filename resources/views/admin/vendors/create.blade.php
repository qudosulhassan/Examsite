    ...
    <div class="bg-white border border-gray-250 rounded-lg p-6 shadow-sm">
        <form action="{{ route('admin.vendors.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" required placeholder="e.g. Amazon Web Services"
                    ...
                    <div class="w-24 h-24 sm:w-28 sm:h-28 rounded-xl border-2 border-dashed border-gray-250 bg-gray-50 flex items-center justify-center p-3 relative overflow-hidden flex-shrink-0 shadow-inner">
                        ...
                        <template x-if="!previewUrl">
                            <div class="text-center text-gray-400">
                                ...
                                <span class="text-[10px] font-bold uppercase tracking-wider block">Upload Logo</span>
                            </div>
                        </template>
                    </div>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" placeholder="Brief details about the vendor..."
            ...
            <div class="bg-gray-50 -mx-6 px-6 py-6 border-t border-b border-gray-150 mb-8">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title') }}" placeholder="e.g., Best Cisco Certification Study Guides"
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="e.g., cisco exams, ccna dumps, cisco practice tests"
                               class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-sm text-gray-700 focus:outline-none focus:border-cyan focus:ring-1 focus:ring-cyan">
