...
class ExamAdminController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'price_bundle' => $request->filled('price_bundle') ? 'numeric|min:0' : 'nullable|numeric|min:0',
    ...
    public function update(Request $request, int $id)
    {
        ...
        $updateData = [
            ...
            'price_bundle' => $request->filled('price_bundle') ? (float)$request->price_bundle : $exam->price_bundle,
            'is_pdf_available' => $isPdf,
            'is_engine_available' => $isEngine,
            'is_bundle_available' => $isBundle,
            'update_price_3_months' => $request->update_price_3_months ?? 0,
